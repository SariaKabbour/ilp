...
export default function ClassDetail() {
    ...
    const classInfo = id ? classesData[id as keyof typeof classesData] : null
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Link to="/" className="text-cyan-400 hover:text-cyan-300 text-lg">
                        Return to Portfolio
                    </Link>
                </div>
            </div>
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            ...
            <nav className="sticky top-0 z-40 bg-slate-900/80 backdrop-blur-md border-b border-slate-700/50">
                <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                    <Link to="/" className="text-2xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent hover:opacity-80 transition">
            ...
            <section className="pt-20 pb-16 px-6">
                <div className="max-w-4xl mx-auto">
                    <Link to="/" className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300 transition">
                    ...
                    <div className={`block px-3 py-1 bg-gradient-to-r ${classInfo.color} bg-clip-text text-transparent text-sm font-semibold mb-4 mt-2 w-fit`}>
                        {classInfo.subject}
                    </div>
            ...
            {classInfo.sections.length > 0 && (
                <section className="pb-20 px-6">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl font-bold mb-12 text-slate-100">Course Materials</h2>
                        <div className="space-y-8">
                            {classInfo.sections.map((section) => (
                                <div key={section.id} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-8 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10">
                                    {section.title && (
                                        <h3 className="text-2xl font-bold text-slate-100 mb-4">{section.title}</h3>
                                    )}
                                            ...
                                            {section.videos.map((videoUrl, idx) => (
                                                <div key={idx}>
                                                    {section.videos!.length > 1 && (
                                                        <p className="text-slate-400 text-sm mb-3 font-semibold">Video {idx + 1}</p>
                                                    )}
                                    ...
                                    <div className="flex flex-wrap gap-4">
                                        {section.pdfUrl && (
                                            <a
                                                href={section.pdfUrl}
                                                download
                                                className="flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/30 text-blue-400 rounded-lg hover:bg-blue-500/20 hover:border-blue-500/50 transition text-sm font-semibold"
                                            >
                                        ...
                                        {section.projectUrl && (
                                            <a
                                                ...
                                                className="flex items-center gap-2 px-4 py-2 bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 rounded-lg hover:bg-cyan-500/20 hover:border-cyan-500/50 transition text-sm font-semibold"
                                            >
                                    ...
                                    {section.codeSnippet && (
                                        <div className="mt-6">
                                            <p className="text-slate-400 text-sm font-semibold mb-3">Code Implementation:</p>
                                            <pre className="bg-slate-900 border border-slate-700/50 rounded-lg p-4 overflow-x-auto text-xs text-slate-300 font-mono leading-relaxed">
                ...
                <section className="pb-20 px-6">
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-12 text-center">
                            <p className="text-slate-400">Course materials coming soon!</p>
                        </div>
                    </div>
                </section>
            )}
